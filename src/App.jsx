import { Float16BufferAttribute, LinearMipMapNearestFilter } from 'three'
import './App.css'
    ...
    <main>
        ...
        <path d="M30.4351,61.1758h-10.4155L0,116.838H10.3479L30.4351,61.1758Z"></path>
          ...
          <div className="bottom">
            ...
            <div className="right">
               <p className='p1'>Dogstudio is a multidisciplinary <br />
creative studio at the intersection <br />
of art, design and technology.</p>
              <p className='p2'>Our goal is to deliver amazing experiences that make <br />
...
entertainment, arts & culture.</p>
        ...
        <section id='section-2'>
          <div className="titles">
            ...
            <div img-title="msi-chicago" className="title">
              <small>2025 - TODAY</small>
              <h1>MSI Chicago</h1>
            </div>
            <div img-title="phone" className="title">
              <small>2020</small>
              <h1>This is Was Louise's Phone</h1>
            </div>
            <div img-title="kikk" className="title">
              <small>2013 - TODAY</small>
              <h1>KIKK Festival 2020</h1>
            </div>
        ...
        <section id='section-3'>
          <div className="top">
            <div className="left">
              <h3>We're crafiting <br /> emotional <br /> experiences aime <br /> at improving <br /> results</h3>
            </div>
            <div className="right">
            </div>
          </div>
          <div className="bottom">
            <div className="left"></div>
            <div className="right">
            <p>Dogstudio is a design & <br /> technology firm working globally <br /> from our offices based in <br /> Belgium and Chicago. <br /> Our strong focus on producing <br /> high quality & emotional <br /> brandings, digital products and <br /> experiences became a signature. </p>
            <p>We're passionate about moving <br /> people and solving problems for <br /> the likes of Microsoft, The <br /> Museum of science And Industry <br /> of Chicago, The Knnedy Center <br /> of Washington, Dragone,Quanta <br /> Magazine, and many more. </p>
            </div>
          </div>
        </section>
    </main>
